...
import { FlatList, TouchableHighlight, Image, StyleSheet, Text, View, Dimensions,Modal} from 'react-native';
  ...
  return(
    <View style={styles.mainWrapper}>
      ...
      <View style={{flexDirection:'row',}}>
        ...
        <View style={{justifyContent:'center',alignItems:'center', marginBottom:20}}><Text style={styles.header} >TAREAS PÚBLICAS</Text></View>
